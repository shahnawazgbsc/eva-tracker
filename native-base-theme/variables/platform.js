...
export default {
  ...
  // Segment
  segmentBackgroundColor: Colors.snow,
  segmentActiveBackgroundColor: Colors.success,
  segmentTextColor: Colors.success,
  segmentActiveTextColor: Colors.white,
  segmentBorderColor: Colors.success,
  segmentBorderColorMain: Colors.success,
