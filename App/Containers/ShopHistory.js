        ...
        return (
            <View style={{ backgroundColor: 'white', margin: 20 }}>
                ...
                <View style={{ borderColor: 'black', borderBottomWidth: 1, marginTop: 10, flex: 1 }}>
                    <View style={{ flexDirection: 'row', alignConten: 'space-around', flex: 1, borderBottomWidth: 0.2, borderColor: "black", marginVertical: 5, justifyContent: 'center' }}>
                        ...
                        <View style={{ flex: 1 }}><Text style={{ fontSize: 13, fontWeight: 'bold', color: "#676767", alignSelf: 'flex-end' }}>Price</Text></View>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', flex: 1, marginVertical: 5, alignItems: 'center' }}>
                        ...
                        <View style={{ flex: 1, justifyContent: 'flex-end', flexDirection: 'row' }}>
                            <Text style={{ fontSize: 13, color: "#616161", alignSelf: 'flex-end' }}>150</Text><Text style={{ fontSize: 10, fontWeight: 'bold', color: "#616161", marginTop: 3 }}>.00</Text>
                        </View>
                    </View>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'flex-end', flex: 1, marginVertical: 5, alignContent: 'center' }}>
                    <Text style={{ fontSize: 13, fontWeight: 'bold', color: "#676767" }}>Total =  </Text><Text style={{ fontSize: 13, color: "#616161" }}>250</Text><Text style={{ fontSize: 10, fontWeight: 'bold', color: "#616161", marginTop: 3 }}>.00</Text>
                </View>
            </View>
        )
    }
        ...
        return (
            <View style={{ flex: 1 }}>
                <View style={{
                    ...
                    backgroundColor: Colors.white, height: 50, borderRadius: 8, alignContent: 'center', justifyContent: 'center',
                    ...
                    <View style={{ flex: 2, alignContent: 'flex-end', justifyContent: 'center' }}>
                        ...
                        }} style={{ alignSelf: 'flex-end', marginRight: 16 }} name={item.open ? "md-arrow-dropup" : "md-arrow-dropdown"} />
                    </View>
                </View>
                {item.open ?
                    this.renderContent()
